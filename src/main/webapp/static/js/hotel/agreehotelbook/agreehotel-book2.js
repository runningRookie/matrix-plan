...
var hotelBook2 = {
    ...
    getServicePrize : function(){		
        ...
        $.ajax({
            ...
            data :JSON.stringify({
                ...
                "hotelCategory" : 3,//酒店类别 1：现付 2：预付 3：协议 
	...
	ToHotelDetail : function(){
        ...
        var form = $("<form></form>");
            form.attr('action', __ctx+"/hotel/agreeHotelDetail")
    ...
    bookHotel : function () {
		...
		$.ajax({
            type:"POST",
            url :__ctx+"/hotelOrder/createAgreementOrder",
