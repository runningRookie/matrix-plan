...
$(function () {
    ...
    var endDate = moment(new Date()).add((trainPreSaleDays < 1 ? 0 : trainPreSaleDays - 1), 'd').format("YYYY-MM-DD");
    ...
    trainQueryVue = new Vue({
        ...
        methods: {
            ...
            pdIsReserved: function (trainObj, ticketObj) {
                ...
                if (ticketObj.seats < employeeNum) {
                    ...
                    action = __ctx + '/train/integration';

                    var form = $("<form></form>");
                    form.attr('action', action);
                    form.attr('method', 'post');
                    var input = $("<input type='text' id='integrationInfo' name='reserveIntegrationParamDTO'/>");
                    form.append(input);
                    form.appendTo("body");
                    form.css('display', 'none');
                    $("#integrationInfo").val(JSON.stringify(reservedData));
                    form.submit();
                }
            }
        }
    ...
    var book1 = {
        ...
        dateShow: function () {
            ...
            var endDate = new Date(new Date().getTime() + (trainPreSaleDays < 1 ? 0 : trainPreSaleDays - 1) * 24 * 3600 * 1000 + 5 * 24 * 3600 * 1000);
            var sDate = startDate.getFullYear() + "-" + (startDate.getMonth() + 1) + "-" + startDate.getDate();
            // var day = startDate.getDate();
            // var month = startDate.getMonth() + 7;
            ...
            // endDate.setDate(endDate.getDate()+trainPreSaleDays);
