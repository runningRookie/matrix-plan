...
$(document).ready(function () {
    ...
    news = new Vue({
        ...
        methods: {
            loadRecord: function () {
                $.ajax({
                    url: __ctx + "/news/querySpecifiedNews",
                    ...
                    success: function (result) {
                        if (!result || !(result.success)) {
                            ...
                            news.newsDTO = result.data;
                            news.newsDTO.newsBody = news.newsDTO.newsBody.replace(/&nbsp;/g, ' ').replace(/<br \/>/g, '\n')
                            news.images = [news.newsDTO.coverUrl];
                        }
                    }
                });
            },
            ...
            check: function () {
                if (this.newsDTO.newsType == null || this.newsDTO.newsType.trim() == '') {
